        ...
        <header>
            ...
            <header>
                ...
                foreach ($courses as $course) {
                    echo "<tr><td>" . $course['course_code'] . "</td><td>" . $course['course_name'] . "</td><td>" . $course['course_description'] . "</td><td>" . $course['course_format'] . "</td><td>" . "<a href='delete.php?id=" . $course['course_code'] . "'> Drop Course</a></td></tr>";
                }
